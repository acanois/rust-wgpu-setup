...
impl State {
    pub async fn new(window: Arc<Window>) -> anyhow::Result<Self> {
        ...
        let render_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            vertex: wgpu::VertexState {
                ...
                buffers: &[vertex::Vertex::desc(), instance::InstanceRaw::desc()], // buffers to pass to v-shader
                compilation_options: wgpu::PipelineCompilationOptions::default(),
            },
            fragment: Some(wgpu::FragmentState {
                // Technically optional, so wrapped in Some()
                module: &shader,
            ...
            primitive: wgpu::PrimitiveState {
                ...
                front_face: wgpu::FrontFace::Ccw, // Ccw = counter-clockwise = facing forward
            ...
            multisample: wgpu::MultisampleState {
                count: 1,                         // Not multisampling
                mask: !0,                         // Which samples are active (all in this case)
                alpha_to_coverage_enabled: false, // Relates to antialiasing (Unused)
            },
            multiview: None, // Not rendering to array textures
    ...
    pub fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
...

        {
            ...
            // Casting "x as _" causes the compiler to infer the type from context
